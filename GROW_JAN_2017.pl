...
sub test_interp
{
    my @angs = (170, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270);
    my @delwextA = (155141960.050013, 346995099.9555, 492005576.139297, 546444796.814329, 497266270.666799, 369369793.624269, 260711872.439888, 194416655.51138, 162602388.030664, 156180638.396523, 165313083.0435);

    my $percent = 0.90;
    my $forecast = 'min';

    my $interp_ang = get_interp_angle(\@angs, \@delwextA, $percent, $forecast);
    print "interp ang: $interp_ang \n";
...
sub test_inter_cor
{
    my %adding;
    $adding{'second 2'} = 180;
    my $inter_struct = get_intersect_structs('test_inter.in');
    my $res = correct_intersections('test_inter.in', \%adding, 0, $inter_struct);
    print "result: $res \n";
}
...
sub correct_intersections
{
	...
	my $n1 = $names[0];
	my $n2 = $names[1];
	print "Fracture $n1 intersects itself \n";
	#die;
	return 1; 
    }
...
sub one_intersect
{
    ...
    my $closest_dist = min_list($db_near, $de_near, $dm_near);
    ...
    #print "s1, s2 = $seg1_s, $seg2_s \n";
    #print "point on seg2 closest to end 1, mid, end 2 $xb_near $yb_near, $xm_near $yb_near, $xe_near $ye_near \n";
    #print "beg, mid, end distance = $db_near, $dm_near, $de_near \n";

    #print "close dist, half length = $closest_dist, $half_length \n";
...
sub closest_point
{
    ...
    #print "seg 2 end pts: @seg2 \n";
    #print "pt on seg2: $x2 $y2 \n";
